...
static char rcsid[] ="$Id: tree.c,v 1.23 1997/12/15 12:47:59 eric Exp $";

/* ADD_FILES changes made by Ross Biro biro@yggdrasil.com 2/23/95 */

/* APPLE_HYB James Pearson j.pearson@ge.ucl.ac.uk 30/12/97 */
...
FDECL1(stat_fix, struct stat *, st)
{
  ...
  */
  st->st_mode |= 0444;
#ifndef _WIN32			/* make every file executable for Win32 */
  if (st->st_mode & 0111)
#endif /* _WIN32 */
    st->st_mode |= 0111;
  st->st_mode &= ~07222;
  ...
  if (strcmp(short_name,".") && strcmp(short_name,"..") && 
      ...
      if(use_RockRidge) 
	{
	 ...
	 is correctly determined. */
      ...
      deep_flag = NEED_CL;
      /* bug fix Paal Kvamme <kvamme3@online.no> */
      s_entry->whole_name = NULL;
    }
